...
int main(int argc, char *argv[])
{
	...
	default: /* Parent Process*/
		...
		wait(NULL); /* Wait for child to finish, if this field is absent, the parent process may finished and return successfull status while child process is running */ 
		exit(EXIT_SUCCESS);
